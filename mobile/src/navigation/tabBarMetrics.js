...
// Matches the bar's own paddingTop(10) + pill height(60) + platform bottom
// inset, plus a little breathing room above it.
export const TAB_BAR_CLEARANCE = Platform.OS === "ios" ? 126 : 110;
