      ...
      >
        ...
        <View style={s.topNav}>
          ...
          <View style={s.navIcons}>
            ...
            <TouchableOpacity style={s.iconBtn} onPress={() => navigation.navigate("Favorites")}>
              <View style={{ position: "relative" }}>
                <Text style={s.iconText}>{favorites.length ? "♥" : "♡"}</Text>
                {favorites.length > 0 && (
                  <View style={s.favBadge}>
                    <Text style={s.favBadgeText}>{favorites.length > 9 ? "9+" : favorites.length}</Text>
                  </View>
                )}
              </View>
            </TouchableOpacity>
...
const s = StyleSheet.create({
  ...
  loader:     { flex: 1, backgroundColor: "#080808", justifyContent: "center", alignItems: "center" },
  loaderText: { color: "#444", fontSize: 10, letterSpacing: 3, textTransform: "uppercase", marginTop: 14 },
  ...
  eyebrow:  { fontSize: 8, letterSpacing: 3, color: "#3a3a3a", fontWeight: "600", marginBottom: 2 },
  navTitle: { fontSize: 22, fontWeight: "900", color: "#FFFFFF", letterSpacing: 5 },
  navDivider: { height: 0.5, backgroundColor: "#1e1e1e", marginHorizontal: 16, marginBottom: 14 },
  ...
  favBadge: {
    ...
    backgroundColor: "#E53E1A", borderRadius: 7,
    minWidth: 13, height: 13,
    justifyContent: "center", alignItems: "center", paddingHorizontal: 2,
  },
  favBadgeText: { fontSize: 7, fontWeight: "800", color: "#FFF" },
  ...
  hero: {
    width: width - 32,
    backgroundColor: "#111",
    borderRadius: 20, borderWidth: 0.5, borderColor: "#222",
  ...
  heroTagWrap:  {
    ...
    borderRadius: 4, borderWidth: 0.5, borderColor: "rgba(255,255,255,0.12)",
    paddingHorizontal: 8, paddingVertical: 3, marginBottom: 10,
  },
  heroTag:   { fontSize: 8, letterSpacing: 2.5, color: "rgba(255,255,255,0.7)", fontWeight: "700" },
  heroTitle: { fontSize: 38, fontWeight: "900", color: "#FFFFFF", lineHeight: 40, letterSpacing: 0.3, maxWidth: 230 },
  heroSub:   { fontSize: 10, color: "rgba(255,255,255,0.4)", marginTop: 6, letterSpacing: 1.5 },
  shopBtn: {
    marginTop: 16, backgroundColor: "#FFFFFF", alignSelf: "flex-start",
    paddingVertical: 10, paddingHorizontal: 20, borderRadius: 8,
  },
  shopBtnText: { fontSize: 10, fontWeight: "800", color: "#000", letterSpacing: 2.5 },
  heroSlideNum: {
  ...
  heroSlideNumText: { fontSize: 9, color: "rgba(255,255,255,0.5)", fontWeight: "700", letterSpacing: 1 },
  heroDots: { flexDirection: "row", gap: 4, marginTop: 12, justifyContent: "center", alignItems: "center" },
  dot:       { width: 5, height: 3, borderRadius: 2, backgroundColor: "#222" },
  ...
  sectionEyebrow: { fontSize: 8, letterSpacing: 3, color: "#3a3a3a", fontWeight: "700", marginBottom: 4 },
  sectionTitle:   { fontSize: 20, fontWeight: "800", color: "#FFFFFF", letterSpacing: 0.3 },
  seeAllBtn:      { paddingBottom: 2 },
  seeAll:         { fontSize: 9, color: "#444", letterSpacing: 1.5, fontWeight: "600" },
  ...
  trendCard: {
    ...
    backgroundColor: "#111",
    borderRadius: 16, borderWidth: 0.5, borderColor: "#222", overflow: "hidden",
  },
  trendImageWrap: {
    width: "100%", height: 160, backgroundColor: "#141414",
  ...
  trendBadge:  { fontSize: 9, color: "#fff", fontWeight: "600" },
  trendBody:   { padding: 12 },
  trendBrand:  { fontSize: 7, fontWeight: "700", letterSpacing: 2.5, color: "#3a3a3a", marginBottom: 3 },
  trendName:   { fontSize: 13, fontWeight: "700", color: "#FFFFFF", lineHeight: 18, marginBottom: 6 },
  trendPrice:  { fontSize: 14, fontWeight: "800", color: "#FFFFFF" },
  ...
  editorialWatermark: {
    ...
    fontSize: 120, fontWeight: "900", color: "rgba(255,255,255,0.03)", letterSpacing: -4,
  },
  editorialDecor: {
  ...
  editorialDecor2: {
    ...
    borderWidth: 0.5, borderColor: "#161616",
  },
  editorialEye:   { fontSize: 8, letterSpacing: 3.5, color: "#3a3a3a", marginBottom: 10, fontWeight: "700" },
  editorialTitle: { fontSize: 30, fontWeight: "900", color: "#FFFFFF", lineHeight: 34, letterSpacing: 0.2 },
  editorialBtn: {
    marginTop: 20, borderWidth: 0.5, borderColor: "#2a2a2a",
    alignSelf: "flex-start", paddingVertical: 10, paddingHorizontal: 18,
    borderRadius: 8, backgroundColor: "rgba(255,255,255,0.04)",
  },
  editorialBtnText: { fontSize: 10, fontWeight: "700", color: "#FFFFFF", letterSpacing: 2 },

  /* JUST DROPPED */
  droppedCard: {
    width: width * 0.72,
    borderRadius: 16, overflow: "hidden", borderWidth: 0.5, borderColor: "#222",
  },
  droppedImageWrap: {
  ...
  droppedBrand: { fontSize: 7, fontWeight: "700", letterSpacing: 2.5, color: "rgba(255,255,255,0.4)", marginBottom: 3 },
  droppedName:  { fontSize: 14, fontWeight: "800", color: "#FFFFFF", marginBottom: 4 },
  droppedPrice: { fontSize: 16, fontWeight: "900", color: "#FFFFFF" },
  limitedTag: {
  ...
  limitedDot:  { width: 5, height: 5, borderRadius: 3, backgroundColor: "#4ade80" },
  limitedText: { fontSize: 7, fontWeight: "700", letterSpacing: 1.5, color: "#fff" },
  ...
  cardImageWrap: {
    width: "100%", aspectRatio: 1, backgroundColor: "#141414",
    justifyContent: "center", alignItems: "center", position: "relative",
  },
  ...
  badge_sale:       { backgroundColor: "#1A1A1A", borderWidth: 0.5, borderColor: "#333" },
  ...
  cardBody:         { padding: 10 },
  cardBrand:        { fontSize: 7, fontWeight: "700", letterSpacing: 2.5, color: "#3a3a3a", marginBottom: 3 },
  cardName:         { fontSize: 13, fontWeight: "700", color: "#FFFFFF", lineHeight: 18, marginBottom: 8 },
  cardFooter:       { flexDirection: "row", justifyContent: "space-between", alignItems: "flex-end" },
  oldPrice:         { fontSize: 10, color: "#333", textDecorationLine: "line-through", marginBottom: 1 },
  ...
  emptyText:  { fontSize: 12, color: "#333", letterSpacing: 2 },

  /* STATS BAR */
  statsBar: {
    flexDirection: "row", justifyContent: "space-around", alignItems: "center",
    marginHorizontal: 16, marginTop: 28,
    backgroundColor: "#111", borderWidth: 0.5, borderColor: "#222",
    borderRadius: 16, paddingVertical: 18,
  },
  statDivider: { width: 0.5, height: 28, backgroundColor: "#222" },
  statItem:    { alignItems: "center", flex: 1 },
  statNum:     { fontSize: 20, fontWeight: "900", color: "#FFFFFF", letterSpacing: 0.5 },
  statLabel:   { fontSize: 8, color: "#3a3a3a", letterSpacing: 2.5, fontWeight: "700", marginTop: 4 },

  /* BRAND FOOTER TAG */
  footerTag: { alignItems: "center", marginTop: 32, paddingBottom: 8 },
  footerTagText: { fontSize: 11, fontWeight: "900", color: "#222", letterSpacing: 5 },
  footerTagSub:  { fontSize: 9, color: "#1e1e1e", letterSpacing: 1.5, marginTop: 4 },
});